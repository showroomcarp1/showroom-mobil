...
export default function DesktopFloatingBar({
  whatsappInquireMsg,
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group flex flex-row items-center justify-start gap-3 px-5 py-4 transition-colors duration-300"
      >
        <svg
      ...
      {/* garis pemisah tidak full di tengah */}
      <div className="px-3">
      ...
      <a
        ...
        className="group flex flex-row items-center justify-start gap-3 px-4 py-3.5 text-neutral-900 transition-colors duration-300"
      >
        <FontAwesomeIcon
